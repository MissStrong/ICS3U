...
So far all of our Turtle programs have had just one turtle. When we first call a method that belongs to the `Turtle` **class**, this creates a `Turtle` **object** that becomes the default turtle in our program. Classes and objects will be covered in more detail in Unit 4.
