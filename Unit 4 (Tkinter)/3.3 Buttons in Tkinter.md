# [Link to video.](https://www.youtube.com/watch?v=usELUlj06xI&list=PLVD25niNi0BnqxVm1TDHLvdHOM3FDaV36&index=9)
...
If we want to pass arguments, we can use a `lambda` function to call the function with the arguments we want. We could also put parameters in the `lambda` function if needed.
