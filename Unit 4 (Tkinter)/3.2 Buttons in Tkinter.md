...
We can disable buttons by setting the value of the key `"state"` to `"disabled"`. This greys out the text on it as a visual cue that it can't be pressed for now. 
