...
label1 = Label(window, text = "Row 0 Column 0")
label1.grid(row = 0, column = 0)
label2 = Label(window, text = "Row 1 Column 1") 
label2.grid(row = 1, column = 1)
label3 = Label(window, text = "Row 2 Column 2")
...
# Creates labels for some text to go on
label1 = Label(window, text = "Row 0 Column 0 and 1")
label1.grid(row = 0, column = 0, columnspan = 2)

label2 = Label(window, text = "Row 1 Column 0")
label2.grid(row = 1, column = 0)

label3 = Label(window, text = "Row 2 Column 1")
