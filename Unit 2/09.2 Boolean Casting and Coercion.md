# [Link to video.](https://www.youtube.com/watch?v=0uzHAQEnmsA&list=PLVD25niNi0Bm4sxSLHOMjqB7ZTPb7Bjxf&index=21)
...
To summarize, the following are all the falsey values in Python:
