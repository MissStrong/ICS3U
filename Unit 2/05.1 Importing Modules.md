...
A module is a file that stores a collection of functions, classes (similar to data types), and global variables. To access these functions, we need to `import` the module. 
