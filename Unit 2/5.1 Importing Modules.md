# [Link to video.](https://www.youtube.com/watch?v=uO6KOSxhNGY&list=PLVD25niNi0Bm4sxSLHOMjqB7ZTPb7Bjxf&index=13)

### Importing Modules

A module is a file that stores a collection of functions, classes (we'll see these next unit), and global variables. To access these functions, we need to `import` the module. 
