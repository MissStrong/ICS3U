...
The default colour of a window in Tkinter is grey. We can change the colour of the screen by modifying the `background` property of `window` as if the window is a dictionary.
