...
**Packing** involves taking several values and placing them into a list, tuple, or other seeuqntial data type. To create a packed variable, we put an asterisk (`*`) in front, which we pronounce as **splat**.
