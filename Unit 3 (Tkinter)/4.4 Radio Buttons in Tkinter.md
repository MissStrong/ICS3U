# [Link to video.](https://www.youtube.com/watch?v=IJ1qUZ1EWfQ&list=PLVD25niNi0BnqxVm1TDHLvdHOM3FDaV36&index=13)

### Radio Buttons in Tkinter

A **radio button** is a group of boxes in which only one box is supposed be checked a time. We can use the `Radiobutton` widget to create radio buttons. 
