...
1. [For Loops in Python](https://drive.google.com/file/d/1KnEcj1p4zjDe6JH3L0p5YetHy8BqMQK1/view?usp=sharing)

## Lesson: For Loops and Advanced Range and Print Statements
...
There are two types of loops in Python: ** *for* loops** and ** *while* loops**. For now we'll just be learning about *for* loops.
